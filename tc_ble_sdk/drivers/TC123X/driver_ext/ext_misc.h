 ...
 *
 *******************************************************************************************************/
#ifndef DRIVERS_TC123X_EXT_MISC_H_
#define DRIVERS_TC123X_EXT_MISC_H_
#include "../register.h"
#include "../flash.h"
 ...
 */
enum{
	SYSTEM_TIMER_TICK_78US125 	= 1875,   //78.125uS = 78.125*24=1875 //78.125*SYSTEM_TIMER_TICK_1US
	SYSTEM_TIMER_TICK_125US 	= 3000,   //125*24   = 3000 //126*SYSTEM_TIMER_TICK_1US
	SYSTEM_TIMER_TICK_156US25 	= 3750,   // 156.25uS = 156.25*16=3750 //156.25*SYSTEM_TIMER_TICK_1US
	SYSTEM_TIMER_TICK_312US5 	= 7500,   // 312.5uS = 312.5*16=7500 //312.5*SYSTEM_TIMER_TICK_1US
...
{
	reg_irq_mask |= FLD_IRQ_SYSTEM_TIMER_EDG_EN;
}
...
{
	return (reg_irq_src & FLD_IRQ_SYSTEM_TIMER_EDG_EN) == FLD_IRQ_SYSTEM_TIMER_EDG_EN;
}
...
{
	reg_irq_src = FLD_IRQ_SYSTEM_TIMER_EDG_EN;
}
