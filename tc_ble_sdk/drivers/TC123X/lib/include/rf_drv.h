...
typedef enum {
	...
	RF_POWER_P9p50dBm  = 44,  /**<  9.5 dbm */
	RF_POWER_P9p00dBm  = 41,  /**<  9.0 dbm */
	RF_POWER_P8p50dBm  = 39,  /**<  8.5 dbm */
	RF_POWER_P8p00dBm  = 36,  /**<  8.0 dbm */
	RF_POWER_P7p75dBm  = 35,  /**<  7.75 dbm */
	RF_POWER_P7p50dBm  = 34,  /**<  7.5 dbm */
	RF_POWER_P7p25dBm  = 33,  /**<  7.25 dbm */
	RF_POWER_P7p00dBm  = 32,  /**<  7.0 dbm */
	RF_POWER_P6p50dBm  = 30,  /**<  6.5 dbm */
	RF_POWER_P6p00dBm  = 29,  /**<  6.0 dbm */
	RF_POWER_P5p50dBm  = 27,  /**<  5.5 dbm */
	RF_POWER_P5p00dBm  = 25,  /**<  5.0 dbm */
	RF_POWER_P4p50dBm  = 24,  /**<  4.5 dbm */
	RF_POWER_P4p00dBm  = 23,  /**<  4.0 dbm */
	RF_POWER_P3p50dBm  = 22,  /**<  3.5 dbm */
	RF_POWER_P3p25dBm  = 21,  /**<  3.25 dbm */
	RF_POWER_P3p00dBm  = 20,  /**<  3.0 dbm */
	RF_POWER_P2p50dBm  = 19,  /**<  2.5 dbm */
	RF_POWER_P2p00dBm  = 18,  /**<  2.0 dbm */
	RF_POWER_P1p50dBm  = 17,  /**<  1.5 dbm */
	RF_POWER_P1p00dBm  = 16,  /**<  1.0 dbm */
	RF_POWER_P0p50dBm  = 15,  /**<  0.5 dbm */
	RF_POWER_P0p00dBm  = 14,  /**<  0.0 dbm */
	RF_POWER_N0p50dBm  = 13,  /**< -0.5 dbm */
	RF_POWER_N1p00dBm  = 12,  /**< -1.0 dbm */
	RF_POWER_N2p00dBm  = 11,  /**< -2.0 dbm */
	RF_POWER_N2p50dBm  = 10,  /**< -2.5 dbm */
	RF_POWER_N3p50dBm  = 9,   /**< -3.5 dbm */
	RF_POWER_N4p50dBm  = 8,   /**< -4.5 dbm */
	RF_POWER_N6p00dBm  = 7,   /**< -6.0 dbm */
	RF_POWER_N7p50dBm  = 6,   /**< -7.5 dbm */
	RF_POWER_N9p00dBm  = 5,   /**< -9.0 dbm */
	RF_POWER_N10p50dBm = 4,   /**< -10.5 dbm */
	RF_POWER_N13p00dBm = 3,   /**< -13.0 dbm */
	RF_POWER_N16p05dBm = 2,   /**< -16.5 dbm */
	RF_POWER_N22p00dBm = 1,   /**< -22.0 dbm */
	RF_POWER_N48p00dBm = 0,   /**< -48.0 dbm */
...
static inline void reset_baseband(void)
{
    ...
    reg_rst0 |= FLD_RST0_ZB;     //release reset signal
}
